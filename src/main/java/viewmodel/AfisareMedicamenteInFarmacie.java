...
public class AfisareMedicamenteInFarmacie implements ICommand{
    private VMManager vmManager;

    public AfisareMedicamenteInFarmacie() {
    }

    public AfisareMedicamenteInFarmacie(VMManager vmManager) {
    ...
    public void execute() {
        ...
        List<MedicamentInFarmacie> medicamentInFarmacieList = farmaciePersistent.listaMedicamenteManager(vmManager.getIdTabelFarmacie());
