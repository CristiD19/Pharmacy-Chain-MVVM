...
public class CautareMedicamentDupaNume implements ICommand{
    private VMManager vmManager;

    public CautareMedicamentDupaNume() {
    }

    public CautareMedicamentDupaNume(VMManager vmManager) {
    ...
    public void execute() {
        ...
        MedicamentInFarmacie medicamentInFarmacie = farmaciePersistent.cautareMedicamentDupaNume(vmManager.getNumeMedicamentTextField(), vmManager.getIdTabelFarmacie());
