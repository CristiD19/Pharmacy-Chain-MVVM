...
public class ListaMedicamenteInFarmacie implements ICommand {
    private VMAngajat vmAngajat;

    public ListaMedicamenteInFarmacie() {
    }

    public ListaMedicamenteInFarmacie(VMAngajat vmAngajat) {
    ...
    public void execute() {
        ...
        List<MedicamentInFarmacie> medicamentInFarmacieList = farmaciePersistent.listaMedicamenteManager(angajat.getFarmacie().getId());
